...
{  
  ...
  LEDs = new char[_LEDframeLength];
  neoBits = new char[_NeoBitsframeLength];
  ...
  _memoryLength = sizeof(neoBits)/sizeof(neoBits[0]);
}

void NeoViaSPI::setPixel(short int pixelIndex, char *pixelColour)
{
...
void NeoViaSPI::getPixel(short int pixelIndex, char *pixelColour)
{
   _counter = 3*pixelIndex;
